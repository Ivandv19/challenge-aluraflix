...
const Boton = styled.button`
  ...
  @media (max-width: 600px) {
    ...
    padding: 5px 15px;
    gap: 10px;
    border: ${(props) => (props.isSelected ? '2px' : '0')} solid
      ${(props) => (props.isSelected ? '#2271D1' : 'white')};
    color: ${(props) => (props.isSelected ? '#2271D1' : 'white')};
    background-color: ${(props) =>
      props.isSelected ? '#2271D13D' : 'transparent'};
  }
`;
...
const BotonesNav = ({ boton, children }) => {
  ...
  return (
    ...
    >
      {children}{' '}
      {/* Los hijos del componente BotonesNav (usualmente texto o iconos dentro del botón) */}
    </Boton>
  );
};
